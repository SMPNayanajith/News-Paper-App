...
function NewsCard({newsItem}) {
  ...
  return (
    <div className='ml-0 h-[200px] items-center justify-center mx-auto sm:w-1/2 md:w-4/12 lg:w-9/12 news-card-wrapper w-full shadow-md shadow-slate-400 rounded-md relative bg-center bg-cover bg-no-repeat'>
